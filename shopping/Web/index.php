...
<body>
   ...
   <div class="container">
      ...
      if (isset($_GET['search'])) {
         ...
         $select_product = mysqli_query($conn, "SELECT * FROM `products` WHERE name LIKE '%$search_query%'") or die('query failed');
         // Check if any products are found
         if (mysqli_num_rows($select_product) === 0) {
            // Display message for no results found
            echo '<div class="message">No products found matching your search.</div>';
         }
      } else {
         // If search query is not set, fetch all products
      ...
      <div class="user-profile">
         ...
         <div class="flex">
            ...
            <a href="login.php?logout=<?php echo $user_id; ?>" onclick="return confirm('Are you sure you want to logout?');" class="delete-btn">Logout</a>
